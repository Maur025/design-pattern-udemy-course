...
function main() {
	...
	const soyBurger = new MenuItem("Hamburguesa de soya", 13.5);
	...
	const beefMenu = new MenuCategory("Menu carnívoro");
	const veganMenu = new MenuCategory("Menu vegano");

	beefMenu.add(steak);
	veganMenu.add(soyBurger);

	mainCourse.add(beefMenu);
	mainCourse.add(veganMenu);
